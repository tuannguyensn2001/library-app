...
@section('module_name')
    <h1>{{trans('readers.create')}}</h1>
@endsection

@section('module')
    <li class="breadcrumb-item active"><a href="{{route('readers.index')}}">{{trans('readers.index')}}</a></li>
    <li class="breadcrumb-item active"><p>{{trans('readers.create')}}</p></li>
@endsection
    ...
    <div class="container">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{trans('readers.create')}}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form_create_reader" method="post" action="{{route('readers.store')}}">
                @csrf
                <div class="card-body">
